...
def attempt_run_once():
    ...
    min_corridor_distance_km = 30.0  # 전체 회랑 최소 거리 제한 (km), 0이면 비활성
    ...
    transition_max_climb_rate_mps = 50
    transition_max_descent_rate_mps = 50
    ...
    takeoff_end_lla = np.array([35.59409827, 129.07496419, float(altitude_levels[0])], dtype=float) # 이륙 끝 지점, 고도를 순항 고도와 일치하도록 설정
    landing_end_lla = np.array([35.60089736, 129.08944809, float(altitude_levels[0])], dtype=float) #  착륙 끝 지점, 고도를 순항 고도와 일치하도록 설정
    ...
    corridor_lat_default = np.array([
        35.5954149, 35.6074955, 35.6128448, 35.6316511, 35.6263030, 35.6128448,
        35.6114644, 35.6259579, 35.6175037, 35.5919630, 35.5729748, 35.5655509,
        35.5683133, 35.5817789, 35.5819516, 35.5923082, 35.6031812,
    ], dtype=float)
    corridor_lon_default = np.array([
        129.0618258, 129.0620381, 129.0412374, 129.0520622, 129.0737120, 129.0830511,
        129.1023660, 129.1063988, 129.1242280, 129.1238035, 129.1042763, 129.0911167,
        129.0658586, 129.0698914, 129.0926024, 129.1108561, 129.1078846,
    ], dtype=float)
