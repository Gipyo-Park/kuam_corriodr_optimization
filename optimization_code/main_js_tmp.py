...
def attempt_run_once():
    ...
    min_feasible_init_solutions = 2  # 진화 시작 전 확보할 최소 통과 초기해 개수(예: 20으로 올리면 초기 다양성 증가)
    ...
    altitude_levels = np.array([550.0], dtype=float)
    ...
    if best_rep is not None:
        ...
        rows.append({
            ...
            "LookAhead_Radius_Scale": "", "Ground_Speed_mps": ground_speed_mps, "Bank_Angle_deg": bank_angle_deg,
        })
        point_idx += 1
