...
def visualize_grc_heatmap_subplots(
    ...
    if compare_save_path is None:
        compare_save_path = PROJECT_ROOT / 'figure' / 'ground_risk_alignment_compare.png'
...
if __name__ == '__main__':
    npy_file = PROJECT_ROOT / "ground_risk_data" / "Modified_high_res_affected_population_GRC.npy"
    visualize_grc_heatmap_subplots(
        npy_file,
        show_plot=True,
        save_path=PROJECT_ROOT / 'figure' / 'Modified_ground_risk_heatmaps.png',
        compare_heading_idx=0,
        compare_save_path=PROJECT_ROOT / 'figure' / 'Modified_ground_risk_alignment_compare.png',
    )
